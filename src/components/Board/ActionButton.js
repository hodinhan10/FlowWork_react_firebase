...
class ActionButton extends Component {
    ...
    renderAddButton = () => {
        ...
        const buttonText = list ? 'Thêm thẻ khác' : 'Thêm danh sách khác';
    ...
    renderForm = () => {
        ...
        const placeholderText = list ? 'Nhập tiêu đề cho thẻ này ...' : 'Nhập tiêu đề danh sách ...';
        const buttonText = list ? 'Thêm Thẻ' : 'Thêm Danh Sách';
